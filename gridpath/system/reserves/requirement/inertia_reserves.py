...
def add_model_components(m, d, scenario_directory, subproblem, stage):
    ...
    generic_add_model_components(
        ...
        reserve_requirement_tmp_param="inertia_reserves_requirement_mw",
        reserve_requirement_percent_param="iner_per_req",
        reserve_zone_load_zone_set="INER_BA_LZ",
        ba_prj_req_contribution_set="INER_BA_PRJ_CONTRIBUTION",
        prj_power_param="iner_prj_pwr_contribution",
        prj_capacity_param="iner_prj_cap_contribution",
...
def load_model_data(m, d, data_portal, scenario_directory, subproblem, stage):
    generic_load_model_data(
        ...
        stage=stage,
        reserve_requirement_param="inertia_reserves_requirement_mw",
        reserve_zone_load_zone_set="INER_BA_LZ",
        reserve_requirement_percent_param="iner_per_req",
        ba_prj_req_contribution_set="INER_BA_PRJ_CONTRIBUTION",
        prj_power_param="iner_prj_pwr_contribution",
